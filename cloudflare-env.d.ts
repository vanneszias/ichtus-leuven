/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=wrangler-types.env --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: e2b6db39645bf085b4b934aaab18e517)
